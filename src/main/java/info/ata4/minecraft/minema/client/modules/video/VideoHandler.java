...
public class VideoHandler extends CaptureModule {
    ...
    protected void doEnable() throws Exception {
        ...
        this.startWidth = MC.getWindow().getWidth();
        this.startHeight = MC.getWindow().getHeight();
    ...
    private void checkDimensions() {
        if (MC.getWindow().getWidth() != startWidth || MC.getWindow().getHeight() != startHeight) {
            throw new IllegalStateException(String.format("Display size changed! Current: %dx%d Start: %dx%d",
                  MC.getWindow().getWidth(), MC.getWindow().getHeight(), startWidth, startHeight));
        }
    }
